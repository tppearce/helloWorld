...
with app.app_context():
    ...
    users = [
        ...
        {'username': 'tppearce', 'email': 'tppearce@terpmail.umd.edu', 'first_name': 'Thomas', 'last_name': 'Pearce',
         'password': generate_password_hash('tppearce', method='pbkdf2:sha256'), 'role': 'STUDENT'}
    ]
